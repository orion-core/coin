...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/orion/orion/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(OrionTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/orion/orion/blob/master/doc/tracing.md#tracepoint-validationblock_connected
