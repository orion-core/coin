...
"""Verify that starting orion with -h works as expected."""

from test_framework.test_framework import OrionTestFramework
from test_framework.util import assert_equal

class HelpTest(OrionTestFramework):
    ...
    def run_test(self):
        self.log.info("Start orion with -h for help text")
        ...
        self.log.info("Start orion with -version for version information")
        ...
        self.log.info("Start oriond with -fakearg to make sure it does not start")
