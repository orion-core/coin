...
class TxnMallTest(OrionTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 ORN:
        ...
        # First: use raw transaction API to send 1240 ORN to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 ORN coin each
        ...
        # Node0's balance should be starting balance, plus 50ORN for another
        ...
        # Node0's total balance should be starting balance, plus 100ORN for
