...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the OrionTestFramework
    pass


class ExampleTest(OrionTestFramework):
    # Each functional test is a subclass of the OrionTestFramework class.
    ...
    def custom_method(self):
        ...
        OrionTestFramework class so other tests can use it."""
