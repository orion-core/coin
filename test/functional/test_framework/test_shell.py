...
class TestShell:
    """Wrapper Class for OrionTestFramework.

    The TestShell class extends the OrionTestFramework
    ...
    class __TestShell(OrionTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by OrionTestFramework child class.
            self.num_nodes = 1
