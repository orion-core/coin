...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/orion/orion/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(OrionTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our oriond node")
