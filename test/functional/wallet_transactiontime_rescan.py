...
class TransactionTimeRescanTest(OrionTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine ORN and create transactions
        ...
        # generate some orn to create transactions and check blockcount
        ...
        # send 10 orn to user's first watch-only address
        self.log.info('Send 10 orn to user')
        ...
        # send 5 orn to our second watch-only address
        self.log.info('Send 5 orn to user')
        ...
        # send 1 orn to our third watch-only address
        self.log.info('Send 1 orn to user')
