...
By default, oriond will dump mempool on shutdown and
...
class MempoolPersistTest(OrionTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent oriond from writing mempool.dat to disk. Verify that `savemempool` fails")
