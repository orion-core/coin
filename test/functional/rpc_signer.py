...
Verify that a oriond node can use an external signer command.
...
class RPCSignerTest(OrionTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart oriond with -signer=<cmd>',
