...
class NetTest(OrionTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=19628)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 19628)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=19628), {"success": False})
