...
This document provides guidelines for internationalization of the Orion Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `orion_en.ts` remains unchanged.
