Download URL: https://sourceforge.net/projects/orion/files/Orion/orion-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 ORN fee schedule (users still pay 0.01 ORN per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #orion00 - #orion99
