Orion Core version 0.9.2.1 is now available from:

  https://orion.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 ORN to 0.01 ORN
...
- Fix "Start orion on system login"
