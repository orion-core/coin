Orion Core version 0.9.4 is now available from:

  https://orion.org/bin/0.9.4/
...
this update is incompatible with the Orion system and could lead to consensus
forks.

Orion Core released binaries from https://orion.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~orion/+archive/ubuntu/orion
- A third-party or self-compiled Orion Core

upgrade to Orion Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
