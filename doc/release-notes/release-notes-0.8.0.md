Orion-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/orion/files/Orion/orion-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Orion
...
New/changed settings (command-line or orion.conf file)
--------------------------------------------------------
