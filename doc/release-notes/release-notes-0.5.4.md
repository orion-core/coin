Orion version 0.5.4 is now available for download at:
http://sourceforge.net/projects/orion/files/Orion/orion-0.5.4/
...
http://gitorious.org/orion/oriond-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Orion-Qt notifications under Growl 1.3.
Increase required age of Orion-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxOrion properly when installing Orion-Qt over it. (Windows)
