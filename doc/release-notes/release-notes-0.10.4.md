Orion Core version 0.10.4 is now available from:

  <https://orion.org/bin/orion-core-0.10.4/>
...
- #6953 `43c2789` Split orion-tx into its own package
- #6953 `dfe0d4d` Include orion-tx binary on Debian/Ubuntu
