...
Orion Core version 0.19.1 is now available from:

  <https://bitcoincore.org/bin/orion-core-0.19.1/>
...
From Orion Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Orion Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Orion Core does not yet change appearance when
...
- #17488 fix "oriond already running" warnings on macOS (fanquake)
