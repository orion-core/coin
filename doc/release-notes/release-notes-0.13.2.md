Orion Core version 0.13.2 is now available from:

  <https://orion.org/bin/orion-core-0.13.2/>
...
- #8908 `4a974b2` Update orion-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow orion-tx to create v2 transactions (orndrak)
