...
""" Interactive oriond P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for Orion Core can enable. It uses BCC
...
def main(oriond_path):
    ...
    oriond_with_usdts.enable_probe(
