...
"""Example logging Orion Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/oriond
...
def main(oriond_path):
    ...
    b = BPF(text=program, usdt_contexts=[oriond_with_usdts])
