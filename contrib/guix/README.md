# Bootstrappable Orion Core Builds

This directory contains the files necessary to perform bootstrappable Orion
Core builds.
...
To build Orion Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Orion Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/orion-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/orion-core/guix.sigs).
