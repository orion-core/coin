...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef ORION_CHAINPARAMSSEEDS_H\n')
    g.write('#define ORION_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the orion network\n')
    ...
    g.write('#endif // ORION_CHAINPARAMSSEEDS_H\n')
