...
# Extract options
function __fish_orion_tx_get_options
...
# Extract commands
function __fish_orion_tx_get_commands
...
complete \
    --command orion-tx \
    --condition "not __fish_orion_seen_cmd (__fish_orion_tx_get_commands --commandsonly)" \
    --arguments "(__fish_orion_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command orion-tx \
    --arguments "(__fish_orion_tx_get_commands)" \
    --no-files
