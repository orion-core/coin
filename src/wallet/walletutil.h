...
#ifndef ORION_WALLET_WALLETUTIL_H
#define ORION_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! orion from opening the wallet, thinking it was newly created, and
...
#endif // ORION_WALLET_WALLETUTIL_H
