...
#ifndef ORION_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define ORION_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // ORION_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
