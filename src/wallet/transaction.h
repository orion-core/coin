...
#ifndef ORION_WALLET_TRANSACTION_H
#define ORION_WALLET_TRANSACTION_H
...
public:
     ...
     * on this orion node, and set to 0 for transactions that were created
...
#endif // ORION_WALLET_TRANSACTION_H
