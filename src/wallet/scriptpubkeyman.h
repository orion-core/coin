...
#ifndef ORION_WALLET_SCRIPTPUBKEYMAN_H
#define ORION_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Orion Core wallet was originally a collection of unrelated private
...
#endif // ORION_WALLET_SCRIPTPUBKEYMAN_H
