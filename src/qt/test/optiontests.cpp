...
{
    // Test regression https://github.com/orion/orion/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/orion-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/orion-core/gui/pull/568.
    // With fListen=false in ~/.config/Orion/Orion-Qt.conf and all else left as default,
    // orion-qt should set both -listen and -listenonion to false and start successfully.
