...
//! Entry point for OrionApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &OrionApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for OrionGUI tests.
void AppTests::guiTests(OrionGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &OrionGUI::consoleShown, this, &AppTests::consoleTests);
