...
#ifndef ORION_QT_ORIONUNITS_H
#define ORION_QT_ORIONUNITS_H
...
/** Orion unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class OrionUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit OrionUnits(QObject *parent);

    /** Orion units.
      @note Source: https://en.orion.it/wiki/Units . Please add only sensible ones
     */
    enum class Unit {
        ORN,
        mORN,
