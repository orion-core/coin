...
#ifndef ORION_QT_GUIUTIL_H
#define ORION_QT_GUIUTIL_H
...
/** Utility functions used by the Orion Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "orion:" URI into recipient object, return true on successful parsing
