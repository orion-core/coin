      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->orionAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->orionAtStartup);
    ...
    ui->orionAtStartup->setToolTip(ui->orionAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->orionAtStartup->setText(ui->orionAtStartup->text().arg(PACKAGE_NAME));

    ui->openOrionConfButton->setToolTip(ui->openOrionConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new OrionUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->orionAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSORNontrols);
...
void OptionsDialog::on_openOrionConfButton_clicked()
{
