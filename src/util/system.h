 ...
 */
#ifndef ORION_UTIL_SYSTEM_H
#define ORION_UTIL_SYSTEM_H
...
extern const char * const ORION_CONF_FILENAME;
extern const char * const ORION_SETTINGS_FILENAME;
