...
#ifndef ORION_UTIL_SYSCALL_SANDBOX_H
#define ORION_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during oriond initialization if Orion Core was compiled
...
#endif // ORION_UTIL_SYSCALL_SANDBOX_H
