...
{
    BOOST_CHECK(TestSplitHost("www.orioncore.org", "www.orioncore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.orioncore.org]", "www.orioncore.org", 0));
    BOOST_CHECK(TestSplitHost("www.orioncore.org:80", "www.orioncore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.orioncore.org]:80", "www.orioncore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:19628", "127.0.0.1", 19628));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:19628", "127.0.0.1", 19628));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:19628", "::ffff:127.0.0.1", 19628));
    BOOST_CHECK(TestSplitHost("[::]:19628", "::", 19628));
    BOOST_CHECK(TestSplitHost("::19628", "::19628", 0));
    BOOST_CHECK(TestSplitHost(":19628", "", 19628));
    BOOST_CHECK(TestSplitHost("[]:19628", "", 19628));
    ...
    BOOST_CHECK(TestSplitHost("www.orioncore.org:65536", "www.orioncore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.orioncore.org:0", "www.orioncore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.orioncore.org:", "www.orioncore.org:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:19628", "127.0.0.1:19628"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:19628", "[::]:19628"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
