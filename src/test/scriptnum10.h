...
#ifndef ORION_TEST_SCRIPTNUM10_H
#define ORION_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Orion Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // ORION_TEST_SCRIPTNUM10_H
