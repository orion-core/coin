...
#ifndef ORION_INTERFACES_NODE_H
#define ORION_INTERFACES_NODE_H
...
//! Top-level interface for a orion node (oriond process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or orion.conf.
