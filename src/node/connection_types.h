...
#ifndef ORION_NODE_CONNECTION_TYPES_H
#define ORION_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/orion-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Orion’s Peer-to-Peer Network")
...
#endif // ORION_NODE_CONNECTION_TYPES_H
