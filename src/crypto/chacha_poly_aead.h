...
#ifndef ORION_CRYPTO_CHACHA_POLY_AEAD_H
#define ORION_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@orion.
 *
 ...
 *
 * The chacha20-poly1305@orion combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@orion cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@orion are relatively fast in
...
#endif // ORION_CRYPTO_CHACHA_POLY_AEAD_H
