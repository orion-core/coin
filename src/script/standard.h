...
#ifndef ORION_SCRIPT_STANDARD_H
#define ORION_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a orion address
 */
...
/**
 * Generate a Orion scriptPubKey for the given CTxDestination. Returns a P2PKH
